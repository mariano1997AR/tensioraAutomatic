...
-160 80 0 80 0 0 440 0 440 -80 0 -80 0 0 -200z"/>
                ...
                <h2 className='card-title'>Personal Tecnico</h2>
                <button
                    className='card-button'
                    onClick={() => setMostrarInfo(!mostrarInfo)}
                >
                    {mostrarInfo ? 'ocultar' : 'ver mas'}

                </button>
                {mostrarInfo && (
                    <p className='card-info'>
                        Esta tarjeta usa un SVG en lugar de una imagen. El texto aparece al presionar el botón.
                    </p>
                )}
