        ...
        <>
            ...
            <nav className="navbar-container mb-4" style={{ borderBottomColor: theme === "dark" ? ' #F5F5F5' : '#4A4947' }}>
                <header className="logo flex items-center gap-2">
                    <p className='logo-dashboard'>Tensiora<span className="azul" style={{ color: theme === "dark" ? '#FCEF91' : '#60B5FF' }}> Electric</span></p>
...
256 5 -167 c5 -149 7 -167 24 -180z"/>
                ...
                <ul className="menu-links desaparece-dispositivo aparece-PC">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle mb-2 py-1" role="button" data-bs-toggle="dropdown">Clientes <FontAwesomeIcon icon={faUsers} /></a>
                        <ul className="dropdown-menu mt-4">
                            {/*base de datos de clientes del usuario */}
                            <li><a href="#" className='dropdown-item item-link-menu'>Cargar clientes</a></li>
                        </ul>
                    </li>
